import svgPaths from "./svg-nhuphs9t7z";
    ...
    <div className="bg-white h-[36px] relative rounded-[4px] shrink-0 w-full" data-name=".forms_fields">
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex gap-[8px] items-center px-[12px] py-[9px] relative size-full">
          <p className="flex-[1_0_0] font-['Averta_Std:Regular',sans-serif] leading-[18px] min-h-px min-w-px not-italic overflow-hidden relative text-[#858fa1] text-[14px] text-ellipsis whitespace-nowrap">business@email.com</p>
        </div>
      </div>
  ...
  return (
    <div className="content-stretch flex flex-col gap-[24px] items-start relative shrink-0 w-full">
      <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 w-full" data-name="Form - Input">
        <div className="content-stretch flex h-[18px] items-center relative shrink-0 w-full" data-name="Label">
