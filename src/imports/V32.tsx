import svgPaths from "./svg-mwwk5i43h4";

function Frame() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-center not-italic relative shrink-0 w-[430px]">
      <p className="font-['Averta_Std:Bold',sans-serif] leading-[32px] relative shrink-0 text-[#344563] text-[24px] w-full">Welcome to Content Studio</p>
      <p className="font-['Averta_Std:Regular',sans-serif] leading-[24px] relative shrink-0 text-[#5d6a82] text-[16px] w-full">Start using it for free. No credit card needed.</p>
    </div>
  );
}
    ...
    <div className="content-stretch flex gap-[12px] items-center relative shrink-0 w-full">
      <div className="flex-[1_0_0] h-0 min-h-px min-w-px relative">
        <div className="absolute inset-[-1px_0_0_0]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 172 1">
            <line id="Line 129" stroke="var(--stroke-0, #D6DAE0)" x2="172" y1="0.5" y2="0.5" />
          </svg>
        </div>
      </div>
      <p className="font-['Averta_Std:Bold',sans-serif] leading-[18px] not-italic relative shrink-0 text-[#5d6a82] text-[14px] text-center whitespace-nowrap">or</p>
      <div className="flex-[1_0_0] h-0 min-h-px min-w-px relative">
        <div className="absolute inset-[-1px_0_0_0]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 172 1">
            <line id="Line 129" stroke="var(--stroke-0, #D6DAE0)" x2="172" y1="0.5" y2="0.5" />
    ...
    <div className="bg-white h-[36px] relative rounded-[4px] shrink-0 w-full" data-name=".forms_fields">
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex gap-[8px] items-center px-[12px] py-[9px] relative size-full">
          <p className="flex-[1_0_0] font-['Averta_Std:Regular',sans-serif] leading-[18px] min-h-px min-w-px not-italic overflow-hidden relative text-[#344563] text-[14px] text-ellipsis whitespace-nowrap">audrey@agorapulse.com</p>
        </div>
      </div>
...
function FormsFields1() {
  return (
    <div className="bg-white h-[36px] relative rounded-[4px] shrink-0 w-full" data-name=".forms_fields">
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex gap-[8px] items-center px-[12px] py-[9px] relative size-full">
          <p className="flex-[1_0_0] font-['Averta_Std:Regular',sans-serif] leading-[18px] min-h-px min-w-px not-italic overflow-hidden relative text-[#344563] text-[14px] text-ellipsis whitespace-nowrap">988727</p>
        </div>
      </div>
      <div aria-hidden="true" className="absolute border border-[#d6dae0] border-solid inset-0 pointer-events-none rounded-[4px]" />
    </div>
...
function Frame4() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0">
      <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 w-[382px]" data-name="Form - Input">
        <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Label">
          <p className="flex-[1_0_0] font-['Averta_Std:Regular',sans-serif] leading-[18px] min-h-px min-w-px not-italic relative text-[#344563] text-[14px]">Enter verification code</p>
        </div>
        <FormsFields1 />
      </div>
      <div className="content-stretch flex gap-[4px] items-center relative shrink-0" data-name="Link">
        <p className="font-['Averta_Std:Bold',sans-serif] leading-[18px] not-italic relative shrink-0 text-[#0e72d6] text-[14px] whitespace-nowrap">Resend code</p>
      </div>
    </div>
  );
}
...
function Frame7() {
  return (
    <div className="content-stretch flex gap-[12px] items-center relative shrink-0 w-full">
      <div className="h-[36px] relative rounded-[4px] shrink-0" data-name="Button">
          ...
          <div className="overflow-clip relative shrink-0 size-[16px]" data-name="Left Icon">
            <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
              <g id="Vector">
                ...
                <path d={svgPaths.p33cdf00} fill="var(--fill-0, #34A853)" />
              </g>
            </svg>
          </div>
          ...
          <div className="overflow-clip relative shrink-0 size-[16px]" data-name="Left Icon">
            <div className="absolute inset-[15%_5%]" data-name="Vector">
              <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 14.4 11.2">
                <path clipRule="evenodd" d={svgPaths.p369e400} fill="var(--fill-0, #5D6A82)" fillRule="evenodd" id="Vector" />
              </svg>
            </div>
          </div>
          <div className="flex flex-col font-['Averta_Std:Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#5d6a82] text-[14px] text-center whitespace-nowrap">
...
function Frame6() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 w-full">
      <p className="font-['Averta_Std:Regular',sans-serif] leading-[16px] not-italic relative shrink-0 text-[#5d6a82] text-[12px] whitespace-nowrap">Go directly on your email provider</p>
      <Frame7 />
    </div>
  );
}
...
function Frame5() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-start relative shrink-0">
      <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 w-[382px]" data-name="Form - Input">
        <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Label">
          <p className="flex-[1_0_0] font-['Averta_Std:Regular',sans-serif] leading-[18px] min-h-px min-w-px not-italic relative text-[#344563] text-[14px]">Enter business email</p>
        </div>
        <FormsFields />
      </div>
      <Frame4 />
...
function Frame8() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 w-full">
      <div className="bg-[#578fff] h-[36px] relative rounded-[4px] shrink-0 w-full" data-name="Button">
...
function Form() {
  return (
    <div className="bg-white content-stretch flex flex-col gap-[24px] items-center justify-center p-[24px] relative rounded-[8px] shrink-0 w-[430px]" data-name="Form">
      <div className="h-[36px] relative rounded-[4px] shrink-0 w-full" data-name="Button">
        <div className="flex flex-row items-center justify-center overflow-clip rounded-[inherit] size-full">
          <div className="content-stretch flex gap-[8px] items-center justify-center px-[16px] py-[8px] relative size-full">
            <div className="overflow-clip relative shrink-0 size-[16px]" data-name="Left Icon">
              <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
...
function Frame3() {
  return (
    <div className="content-stretch flex gap-[8px] items-center relative shrink-0 w-[430px]">
      <p className="font-['Averta_Std:Regular',sans-serif] leading-[18px] not-italic relative shrink-0 text-[#5d6a82] text-[14px] whitespace-nowrap">Already have an account?</p>
      <div className="content-stretch flex gap-[4px] items-center relative shrink-0" data-name="Link">
        <p className="font-['Averta_Std:Bold',sans-serif] leading-[18px] not-italic relative shrink-0 text-[#0e72d6] text-[14px] whitespace-nowrap">Log in</p>
      </div>
    </div>
  );
}
